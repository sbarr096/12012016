...
$namedb   = "breaker4"; // MySQL database name
...
if ($result) {
    ...
    $arrData = array(
        "chart" => array(
            "caption" => "Breaker 4 Yearly Consumption",
            "xAxisName"=> "Year",
					...
					$arrMonthHeader[$year][$row["Quarter"]] = array(
										...
										"linkedchart" => array(
											"chart" => array(
												...
												"caption" => "$year-".$row["Quarter"].":  Breaker 4 Monthly Wattage Consumption ",
												"xAxisName"=> "Month",
                    ...
                    array_push($arrData["linkeddata"], array(
                        ...
                        "linkedchart" => array(
                            "chart" => array(
                                ...
                                "caption" => "$year:  Breaker 4 Quarterly Wattage Consumption ",
                                "xAxisName"=> "Quarter",
                                "yAxisName"=> "KiloWatt Hours",
