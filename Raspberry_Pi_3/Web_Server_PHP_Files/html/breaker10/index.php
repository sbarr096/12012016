...
$namedb   = "breaker10"; // MySQL database name
...
if ($result) {
    ...
    $arrData = array(
        "chart" => array(
            "caption" => "Breaker 10 Yearly Consumption",
            "xAxisName"=> "Year",
					...
					$arrMonthHeader[$year][$row["Quarter"]] = array(
										...
										"linkedchart" => array(
											"chart" => array(
												...
												"caption" => "$year-".$row["Quarter"].":  Breaker 10 Monthly Wattage Consumption ",
												"xAxisName"=> "Month",
                    ...
                    array_push($arrData["linkeddata"], array(
                        ...
                        "linkedchart" => array(
                            "chart" => array(
                                ...
                                "caption" => "$year:  Breaker 10 Quarterly Wattage Consumption ",
                                "xAxisName"=> "Quarter",
                                "yAxisName"=> "KiloWatt Hours",
