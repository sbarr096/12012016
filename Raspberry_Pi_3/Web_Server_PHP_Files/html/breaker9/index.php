...
$namedb   = "breaker9"; // MySQL database name
...
if ($result) {
    ...
    $arrData = array(
        "chart" => array(
            "caption" => "Breaker 9 Yearly Consumption",
            "xAxisName"=> "Year",
					...
					$arrMonthHeader[$year][$row["Quarter"]] = array(
										...
										"linkedchart" => array(
											"chart" => array(
												...
												"caption" => "$year-".$row["Quarter"].":  Breaker 9 Monthly Wattage Consumption ",
												"xAxisName"=> "Month",
                    ...
                    array_push($arrData["linkeddata"], array(
                        ...
                        "linkedchart" => array(
                            "chart" => array(
                                ...
                                "caption" => "$year:  Breaker 9 Quarterly Wattage Consumption ",
                                "xAxisName"=> "Quarter",
                                "yAxisName"=> "KiloWatt Hours",
